        ...
        <div className=' xl:w-[75rem]   px-3 my-10'>
            <div className='md:flex md:gap-32 lg:gap-10 md:justify-between'>
                <div className=' md:w-[40%]  '>
                    <h2 className=' text-2xl sm:text-3xl italic font-semibold'><span className=' text-[#6C3BC3]'>Job</span><span className=' text-[#FA4F09]'>hunt</span></h2>
            ...
            <p className=' text-center mt-10 text-sm'>&copy;copy 2024 Jobhunt - All Rights Reserved</p>
        </div>
    )
}
